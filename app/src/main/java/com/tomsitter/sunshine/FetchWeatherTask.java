...
import com.tomsitter.sunshine.data.WeatherContract;
...
public class FetchWeatherTask extends AsyncTask<String, Void, String[]> {
     ...
     */
    private String[] getWeatherDataFromJson(String forecastJsonStr, int numDays, String location)
